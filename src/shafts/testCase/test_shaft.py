...
class TestShaft(TestCase):
    def setUp(self):
        ...
        self.stl_trained_record = {
            100: os.path.join(
                self.path_prefix,
                self.target_var,
                "check_pt_{0}_100m".format(self.backbone),
                "experiment_1",
                "checkpoint.pth.tar",
            ),
            250: os.path.join(
                self.path_prefix,
                self.target_var,
                "check_pt_{0}_250m".format(self.backbone),
                "experiment_1",
                "checkpoint.pth.tar",
            ),
            500: os.path.join(
                self.path_prefix,
                self.target_var,
                "check_pt_{0}_500m".format(self.backbone),
                "experiment_1",
                "checkpoint.pth.tar",
            ),
            1000: os.path.join(
                self.path_prefix,
                self.target_var,
                "check_pt_{0}_1000m".format(self.backbone),
                "experiment_1",
                "checkpoint.pth.tar",
            ),
        }
        self.mtl_trained_record = {
            100: os.path.join(
                self.path_prefix,
                self.target_var,
                "check_pt_{0}_100m_MTL".format(self.backbone),
                "experiment_1",
                "checkpoint.pth.tar",
            ),
            250: os.path.join(
                self.path_prefix,
                self.target_var,
                "check_pt_{0}_250m_MTL".format(self.backbone),
                "experiment_1",
                "checkpoint.pth.tar",
            ),
            500: os.path.join(
                self.path_prefix,
                self.target_var,
                "check_pt_{0}_500m_MTL".format(self.backbone),
                "experiment_1",
                "checkpoint.pth.tar",
            ),
            1000: os.path.join(
                self.path_prefix,
                self.target_var,
                "check_pt_{0}_1000m_MTL".format(self.backbone),
                "experiment_1",
                "checkpoint.pth.tar",
            ),
        }
    ...
    def test_inference_STL(self):
        ...
        sample_loc = {
            "THU": {
                ...
                "raw_data": {
                    "50pt": {
                        self.s1_key: os.path.join(
                            shafts._path_shaft_module,
                            "testCase",
                            "infer_test_THU/raw_data/THU_2020_sentinel_1_50pt.tif",
                        ),
                        self.s2_key: os.path.join(
                            shafts._path_shaft_module,
                            "testCase",
                            "infer_test_THU/raw_data/THU_2020_sentinel_2_50pt.tif",
                        ),
                    }
                },
                "aux_feat": {
                    "DEM": {
                        "path": os.path.join(
                            shafts._path_shaft_module,
                            "testCase",
                            "infer_test_THU/raw_data/THU_srtm.tif",
                        ),
        ...
        for loc in sample_loc.keys():
            ...
            for target_res in [100]:
                ...
                shafts.pred_height_from_tiff_DL_patch(
                    extent=extent,
                    ...
                    tmp_suffix="_stl_{0}".format(target_res),
    ...
    def test_inference_MTL(self):
        ...
        for loc in sample_loc.keys():
            ...
            for target_res in [100]:
                ...
                shafts.pred_height_from_tiff_DL_patch_MTL(
                    extent=extent,
                    ...
                    padding=self.padding,
                    batch_size=self.batch_size,
                    tmp_suffix="_mtl_{0}".format(target_res),
                    log_scale=False,
                    cuda_used=self.cuda_used,
                    h_min=self.v_min,
                    h_max=self.v_max,
